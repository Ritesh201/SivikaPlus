...
import {
  ...
  LogOut, Store, Bell, User, UserCircle
} from 'lucide-react'
...
const NAV = [
  ...
  { to: '/seller/profile',      label: 'My Account',  icon: UserCircle },
]
...
export default function SellerLayout() {
  ...
  const verificationStatus = user?.verified==true?'APPROVED':'PENDING' || 'PENDING'
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '1.5rem 1.25rem', borderBottom: '1px solid rgba(255,255,255,.1)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.6rem' }}>
            ...
            <div>
              <p style={{ color: '#fff', fontWeight: 800, fontSize: '1rem', lineHeight: 1 }}>SivikaPlus</p>
        ...
        <div style={{ padding: '1rem 1.25rem', borderBottom: '1px solid rgba(255,255,255,.1)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.7rem' }}>
            <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'rgba(255,255,255,.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, overflow: 'hidden' }}>
        ...
        <div style={{ padding: '.75rem', borderTop: '1px solid rgba(255,255,255,.1)' }}>
          <button onClick={handleLogout} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '.7rem', padding: '.65rem .75rem', borderRadius: '.6rem', border: 'none', background: 'transparent', color: '#fca5a5', cursor: 'pointer', fontWeight: 500, fontSize: '.875rem' }}>
      ...
      <div style={{ marginLeft: '240px', flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        {/* Top bar */}
        <header style={{ height: 60, background: '#fff', borderBottom: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', padding: '0 1.5rem', position: 'sticky', top: 0, zIndex: 30 }}>
          <div style={{ flex: 1 }} />
        ...
        {verificationStatus === 'PENDING' && (
          <div style={{ background: '#fffbeb', borderBottom: '1px solid #fde68a', padding: '.75rem 1.5rem', display: 'flex', alignItems: 'center', gap: '.75rem' }}>
